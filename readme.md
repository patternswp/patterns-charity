...
> `Patterns Charity` is a compassionate and purpose-driven block-based WordPress theme designed for charities, non-profits, humanitarian organizations, and fundraising initiatives.
...
- [Patterns Charity](#patterns-charity)
...
- **Elegant Design:** Perfect for charities, non-profits, fundraising organizations, and humanitarian initiatives.
- **Responsive Layouts:** Optimized for seamless display on all devices.
- **Pre-designed Templates:** Includes layouts for showcasing feature sections, services, about, testimonials, contact page, and more.
...
- Clone the repository to your `/wp-content/themes/` directory:
  ...
  ```bash
  git clone https://github.com/patternswp/patterns-charity.git
  ```

- Or download and upload the theme files to `/wp-content/themes/patterns-charity`.
...
We welcome contributions to improve Patterns Charity! Here's how you can contribute:
...
2. **Clone your Fork**
   ...
   ```bash
   git clone https://github.com/your-username/patterns-charity.git
   ```
