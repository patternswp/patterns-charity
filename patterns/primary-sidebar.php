 ...
 * Slug: patterns-charity/primary-sidebar
 * Categories: posts
...
<div class="wp-block-group">
	<!-- wp:pattern {"slug":"patterns-charity/search-form"} /-->
	<!-- wp:pattern {"slug":"patterns-charity/latest-posts"} /-->
	<!-- wp:pattern {"slug":"patterns-charity/latest-comments"} /-->
</div>
<!-- /wp:group -->
